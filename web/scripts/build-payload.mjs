...
const FIGURES = [
  ...
  { exp: 'tool_calls/bash_command_breakdown', file: 'executable_popularity.png', dest: 'tool_calls/executable_popularity.png' },
  { exp: 'tool_calls/bash_command_breakdown', file: 'executable_popularity_by_provider.png', dest: 'tool_calls/executable_popularity_by_provider.png' },
  { exp: 'tool_calls/bash_command_breakdown', file: 'executable_runtime.png', dest: 'tool_calls/executable_runtime.png' },
